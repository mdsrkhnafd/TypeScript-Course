...
var anchorElClass = document.querySelector(".anchorStyle") as HTMLAnchorElement; // Type assertion to tell TypeScript that anchorElClass is an HTMLAnchorElement
...
var headingElId = document.getElementById("heading") as HTMLHeadingElement; // Non-null assertion operator to tell TypeScript that headingElId will not be null
